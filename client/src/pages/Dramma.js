  ...
  return (
    <div>
          ...
          <div style={{padding: '10px 200px 0px'}}>
            ...
            <ul>
            <hr></hr>
            <Film  text_head = "1 + 1" ref_video = "https://youtu.be/34WIbmXkewU"
    ref_img = "https://upload.wikimedia.org/wikipedia/ru/b/b9/Intouchables.jpg"
  text_desc ="Пострадав в результате несчастного случая, богатый аристократ Филипп нанимает в помощники человека, 
